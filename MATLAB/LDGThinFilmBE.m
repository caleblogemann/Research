function [A] = LDGThinFilmBE(num_elems, num_basis_cpts, original_q, deltaT, a, b, diffusivity, bc)
    ...
    LDGMatrix = getLDGThinFilmMatrix(restricted_original_q, num_elems, num_basis_cpts, deltaX, diffusivity, bc);
