  ...
  \section{Derivation}
    ...
    \begin{frame}
      ...
      \begin{align*}
        ...
        P + \Phi &= \eval{\Phi}{Z = H} - C^{-1} H_{XX} - \Pi \\
        U &= \p{\tau + \Sigma_X}Z - \p{P_X + \Phi_X}\p{HZ - \frac{1}{2}Z^2} \\
        0 &= H_T + \p{\p{\tau + \Sigma_X}\frac{1}{2}H^2 - \p{P_X + \Phi_X}\frac{1}{3}H^3}_X \\
        P_X + \Phi_X &= \p{\eval{\Phi}{Z = H} - \Pi}_X - C^{-1} H_{XXX}
      \end{align*}

      \small{\begin{gather*}
        H_T + \p{\frac{1}{2}\p{\tau + \Sigma_X}H^2 - \frac{1}{3}\p{\eval{\Phi}{Z = H} - \Pi}_X H^3}_X = - \frac{1}{3}C^{-1}\p{H^3 H_{XXX}}_X
      \end{gather*}}
    \end{frame}
  ...
  \subsection{Diffusion}
    ...
    \begin{frame}
      ...
      \begin{itemize}
        ...
        \item Full operator
          \[
            L(q^{n+1}) = L(f = \p{q^{n+1}}^3, q^{n+1}) = Aq^{n+1}
          \]
      \end{itemize}
    \end{frame}
