...
\begin{document}
  ...
  \section{Mapping}
    ...
    \end{align*}
    \begin{align*}
      \p{h_s}_t + u(t, x, y, h_s) \p{h_s}_x + v(t, x, y, h_s) \p{h_s}_y &= w(t, x, y, h_s) \\
      \p{h_b}_t + u(t, x, y, h_b) \p{h_b}_x + v(t, x, y, h_b) \p{h_b}_y &= w(t, x, y, h_b)
    \end{align*}
    ...
    \end{align*}
    \begin{align*}
      \p{h_s}_t + \tilde{u}(t, x, y, 1) \p{h_s}_x + \tilde{v}(t, x, y, 1) \p{h_s}_y &= \tilde{w}(t, x, y, 1) \\
      \p{h_b}_t + \tilde{u}(t, x, y, 0) \p{h_b}_x + \tilde{v}(t, x, y, 0) \p{h_b}_y &= \tilde{w}(t, x, y, 0)
    \end{align*}
