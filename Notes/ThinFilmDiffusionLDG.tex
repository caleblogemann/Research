...
\textbf{\large{Local Discontinuous Galerkin Method}}
  ...
  \begin{align*}
    \dintt{I_j}{}{u_h z_h}{x} &= \dintt{I_j}{}{q_h^3 (s_h)_x z_h}{x} \\
    \dintt{I_j}{}{u_h z_h}{x} &= \p{\p{\hat{r}_h \hat{q_h^3} z^-_h}_{j+1/2} - \p{\hat{s}_j \hat{q_h^3} z^+_h}_{j-1/2}} - \dintt{I_j}{}{s_h (q_h^3 z_h)_x}{x} \\
    \dintt{I_j}{}{u_h z_h}{x} &= \p{\p{\hat{r}_h \hat{q_h^3} z^-_h}_{j+1/2} - \p{\hat{s}_j \hat{q_h^3} z^+_h}_{j-1/2}} \\
